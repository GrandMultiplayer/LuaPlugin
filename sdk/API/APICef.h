...
namespace API
{
	namespace CEF
	{
		...
		DLL_PUBLIC_I_C void LoadURL(Objects::Entity entity, const char * frame, const char * url, const char * appcode = "", bool remote = false);
		...
		DLL_PUBLIC_I_C void ExecuteJavaScript(Objects::Entity entity, const char * frame, const char * call);
	}
}

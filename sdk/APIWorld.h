...
extern "C" {
	...
	namespace API
	{
		...
		public:
			...
			DLL_PUBLIC_I static void SetBlackout(const int entity, const bool state);
			/// <summary>
			/// Gets the blackout state
			/// </summary>
			/// <returns>The state of the blackout</returns>
			DLL_PUBLIC_I static const bool IsBlackout();
			/// <summary>
			...
			DLL_PUBLIC_I static void SetGroundSnow(const bool state);
			/// <summary>
			...
			/// <param name="state">The state ground snow textures should be in</param>
			DLL_PUBLIC_I static void SetGroundSnow(const int entity, const bool state);
			/// <summary>
			/// Gets wether the ground snow textures state for everyone.
			/// </summary>
			/// <returns>The state of the ground snow textures</returns>
			DLL_PUBLIC_I static const bool IsGroundSnow();
		};
	}
#ifdef __cplusplus
}
